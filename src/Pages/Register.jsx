  ...
  return (
    ...
    <motion.div initial={{ opacity: 0 , y: 30}} animate={{ opacity: 1 , y: 0}}
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-neutral-900">register your account</h1>
          <p className="text-neutral-600 mt-2 text-center">Enter your name and email and password to continue.</p>
        </div>
